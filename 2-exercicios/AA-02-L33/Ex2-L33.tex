...
\def\ua{02}
\def\myling{{33}} % Informe o número da linguagem selecionada.
...
% \begin{tcolorbox}[rounded corners, colback=yellow!5, 
% colframe=red!40!black, title=\textbf{\matricula\ -- \discente}]
% \begin{itemize}[leftmargin=*]
...
%   $$\mathcal{CR}(\mathcal{L}_\myling) =
% * * * * * * * * * * * * * * * * * * * * * * 
%    \{0\}\concatL(\{0\}\cup \{1\}\concatL\{1\}^+\concatL\
% {0\})^*\concatL\{10\}\concatL(\{0\}\cup \{1\}\concatL\
% {1\}^+\concatL\{0\})^*
% * * * * * * * * * * * * * * * * * * * * * * 
%   .$$
% \end{itemize}
...
% \begin{itemize}[leftmargin=*]
  ...
  % $$\mathcal{CR}(\mathcal{L}_\myling) =
%% * * * * * * * * * * * * * * * * * * * * * * 
  %  \{0\}\concatL\{0,1\}^*\concatL\{1\}\cup\{1\}\concatL\
  % {0,1\}^*\concatL\{0\}
%% * * * * * * * * * * * * * * * * * * * * * * 
  % .$$
 % \end{itemize}
